...
%%Research highlights
\begin{highlights}
	\item First robust numerical method for Generalised Serre-Green-Naghdi Model.
	\item Validated for smooth and non-smooth analytic solutions.
	\item Validated for general forced solutions. 
	\item Demonstration of advancing dispersive wave region.
\end{highlights}
