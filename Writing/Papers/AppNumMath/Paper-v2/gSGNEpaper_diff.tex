...
%DIF ADD gSGNpaper.tex       Sat Jun 25 10:15:45 2022
...
%DIF > Since the numerical scheme's foundation is a finite volume method for an equation in conservation law shown to work well for nonlinear non-dispersive equations \cite{Kurganov-Petrova-2007-707} this scheme should be valid for all values of $\beta_1$ and $\beta_2$ without specialised modification. 
