...
The evolution of an initial rectangular depression wave in the free surface was studied experimentally by \citet{Hammack-Segur-1978-337}. The experiments were conducted in a wave tank $0.394m$ wide, $31.6m$ long and $0.61m$ high filled by water $h_0 = 0.1m$ deep. The initial wave was generated by a $0.61m$ long piston with its left edge flush with the left edge of the wave tank. The piston is originally in the up position with the water stationary, the piston is then dropped creating the rectangular depression in the surface, which generates a dispersive shock wave. This dispersive shock wave has its rarefaction fan component propagate up the wave tank, while the front of the dispersive shock wave reflects from the left edge of the wave tank and propagates back up the wave tank. The evolution of these waves is recorded at timeseries of the wave tank is recorded by Wave Gauges (WG) located $0m$, $5m$, $10m$, $15m$ and $20m$ away from the right edge of the piston. Two heights of the rectangular wave were investigated $h_0 - h_1 = 0.01m$ and $h_0 - h_1 = 0.03m$ where $h_1$ is the height of the water above the piston after it drops. 
