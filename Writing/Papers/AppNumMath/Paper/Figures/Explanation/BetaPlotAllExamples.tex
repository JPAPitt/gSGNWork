...
\node[] at (axis cs: 0.1,0.035) {(a)};
\node[] at (axis cs: 0.63,0.04) {(d)};
\node[] at (axis cs: 0.74,0.15) {(c)};
\node[] at (axis cs: 0.89,0.96) {(b)};
\node[] at (axis cs: 0.333,0.72) {(e)};
%\node[] at (axis cs: 0.7,0.15) {$\mathcal{O}\left(k^5\right)$};
