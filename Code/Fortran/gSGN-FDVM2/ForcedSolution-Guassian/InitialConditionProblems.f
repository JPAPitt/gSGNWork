...
c ====
c Subroutine that generates the Gaussian forced solution at the cell centers (equivalent to cell averages for second order methods)
c This is an forced solution for all beta values (indeed even varying beta values, as done here)
...
c
c ===== 
      SUBROUTINE ForcedGaussian(xbc,xbc_len,t,
     . a0,a1,a2,a3,a4,a5,b1a6,b1a7,h,u,G)
      IMPLICIT NONE
      ...
      !Local variables             
      DOUBLE PRECISION PHI,EXPPHI1,dhdx,dudx,d2udx2,beta1
      INTEGER i
