...
ExpRes = "\Data\Segur-3cm\";
Sim1Res = "\Experimental\SegurSGN\3cm\01\";
Sim2Res = "\Experimental\SeguriSGN\3cm\01\";
Sim3Res = "\Experimental\SegurSWWE\3cm\01\";
...
for i = 1:5
    ExpFig = importdata(strcat(wdirbase,ExpRes,'fig3',letters(i),'.txt' ));
    ...
    str1 = ['Seg3cm',char(letters(i)),'.tex'];
    cleanfigure;
%     matlab2tikz(str1); 
end
