...
wdir = "/home/jp/Documents/Work/PostDoc/Projects/Steve/1DWaves/RegularisedSerre/Data/RAW/Presentations/CTAC/Animation/DB5/00/";
...
%     xticks([-0,0,50,100,150]);
%     yticks([0.8,1,1.2,1.4,1.6,1.8]);
    xlabel('x (m)')
    ylabel('h (m)')
    text(-1000,2.1,strcat('t = ',sprintf("%5.2f",t(i))),'fontsize',fontsizenum,'fontname','cmr12');
    text(-600,2.1,strcat('\beta_1 = ',sprintf("%5.2f",beta1(i))),'fontsize',fontsizenum,'fontname','cmr12');
    text(-200,2.1,strcat('\beta_2 = ',sprintf("%5.2f",beta2(i))),'fontsize',fontsizenum,'fontname','cmr12');
    hold on;
