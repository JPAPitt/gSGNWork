...
def PlotBuildUpToQuad(x,q,dx,nG,np):
    ...
    for i in range(nG,n-nG):
        ...
        #         Ra0 = P3jm3toja30
        #     else:
        #         if (abs(P2jm2tojSI -P2jm1tojp1SI) > errtol and abs(P2jtojp2SI -P2jm1tojp1SI) > errtol and abs(P2jtojp2SI -P2jm2tojSI) > errtol ):
        #             if P2jm2tojSI < min(P2jm1tojp1SI ,P2jtojp2SI) :
        #                 Ra3 = 0
        #                 Ra2 = P2jm2toja22
        #                 Ra1 = P2jm2toja21
        #                 Ra0 = P2jm2toja20
        #             elif P2jm2tojSI < min(P2jm1tojp1SI ,P2jtojp2SI) :
        I1= -1
        Ra3 = 0.5*(P3jm3toja33 + P3jtojp3a33)
        Ra2 = 0.5*(P3jm3toja32 + P3jtojp3a32)
        Ra1 = 0.5*(P3jm3toja31 + P3jtojp3a31)
        Ra0 = 0.5*(P3jm3toja30  + P3jtojp3a30)    
        ...
        if i == nG:
            ...
            plot(xplot, LimP3R, '-g',label='Recon P3 j-2,j+2')
            plot(xplot, P3jtojp3P, '-r',label='Recon P3 j,j+3')
            plot(xplot, P3jm3tojP , '-b',label='Recon P2 j-3,j')
            ...
            plot(xplot, LimP3R, '-g')
            plot(xplot, P3jtojp3P, '-r')
            plot(xplot, P3jm3tojP , '-b')
