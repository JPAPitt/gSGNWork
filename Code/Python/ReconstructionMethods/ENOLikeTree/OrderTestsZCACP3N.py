...
def ReconCoeffs(qajm3,qajm2,qajm1,qaj,qajp1,qajp2,qajp3,dx):
     ...
     if I1 == 1:
         ...
         if (abs(P3jm3tojSI-P3jtojp3SI) < 10.0**(-14)):
             I1 = 0
         else:
             Ra3 = P3jtojp3a33
             Ra2 = Ra2 - 3*dx*Ra3
     ...
     #undecided
     if (I1 == 0):
         if( abs(P3jm3tojSI-P3jtojp3SI) < 10.0**(-12)  and  P3jtojp3a33 == P3jm3toja33 and  P3jtojp3a32 == P3jm3toja32 and  P3jtojp3a31 == P3jm3toja31 and  P3jtojp3a30 == P3jm3toja30):
             Ra3 = P3jm3toja33
             Ra2 = P3jm3toja32
             Ra1 = P3jm3toja31
             Ra0 = P3jm3toja30    
             ...
             Ra1 = P2jm1tojp1a21
             Ra0 = P2jm1tojp1a20
         elif( abs(P1jtojp1SI- P1jm1tojSI) < 10.0**(-12)  and P1jtojp1a11 == P1jm1toja11 and P1jtojp1a10 == P1jm1toja10 ):
             Ra3 = 0
             Ra2 = 0
             Ra1 = P1jtojp1a11
             Ra0 = P1jtojp1a10
