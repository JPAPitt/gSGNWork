    ...
    for i in range(nG,n-nG):
        ...
        if I1 == 0:
            ...
            if (abs( P3jm3tojSI - P3jtojp3SI)  < 10.0**-14):
                ...
                if ( abs(P3jm3toja33 - P3jtojp3a33) < 10.0**-14 \
                    and  abs(P3jm3toja32 - P3jtojp3a32) < 10.0**-14 \
                    and  abs(P3jm3toja31 - P3jtojp3a31) < 10.0**-14 \
                    and  abs(P3jm3toja30 - P3jtojp3a30) < 10.0**-14 ):
                    Ra3 = P3jm3toja33
                    Ra2 = P3jm3toja32
                    Ra1 = P3jm3toja31
                    Ra0 = P3jm3toja30
                ...
                elif( abs(P2jtojp2SI- P2jm2tojSI) < 10.0**(-14)  and P2jm1tojp1SI < P2jm2tojSI  ):
                    Ra3 = 0
                    Ra2 = P2jm1tojp1a22
                    Ra1 = P2jm1tojp1a21
                    Ra0 = P2jm1tojp1a20
