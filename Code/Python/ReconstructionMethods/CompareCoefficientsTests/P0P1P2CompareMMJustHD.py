...
def LimP2(Pjm2j,Pjm1jp1,Pjjp2,Pjm2jp2,Pjm1j,Pjjp1):
    ...
    # PLCSign(Qq,1)
    if (PLCSign(QqFull,2)):
        # Ra2,ind1 = minmodL([Pjm2j[2],Pjm1jp1[2],Pjjp2[2],Pjm2jp2[2]] )
        # Ra1 = QqFull1[ind1][1]
        # Ra0 = QqFull1[ind1][0]
        Ra0 =2
    else:      
...
def PlotBuildUpToQuad(x,q,dx,nG,np):
    ...
    for i in range(nG,n-nG):
        ...
        RccjP  = Ra1*(xplot - x[i]) + Ra0
        Ra1MM,ia1 = minmodL([P1jm1toja11,0.5*(P1jm1toja11+ P1jtojp1a11),P1jtojp1a11])
        RMMP = Ra1MM*(xplot - x[i]) + qaj
        ...
        # Ra1,Ra2 = LimP2([P2jm2toja21,P2jm2toja22],[P21jm1tojp1a21,P2jm1tojp1a22],[P2jtojp2a21,P2jtojp2a22],[P4a1,P4a2])
        ...
        print()
        Ra1,ia1 =minmodL([P1jm1toja11,0.5*(P1jm1toja11+ P1jtojp1a11),P1jtojp1a11]) 
        print('ReconMM %2.12f %2.12f'%(qaj,Ra1))
        
        
                
        Ra0,Ra1,Ra2 = LimP2([P2jm2toja20,P2jm2toja21,P2jm2toja22],[P2jm1tojp1a20,P2jm1tojp1a21,P2jm1tojp1a22],[P2jtojp2a20,P2jtojp2a21,P2jtojp2a22],[P4a0,P4a1,P4a2],[P1jm1toja10,P1jm1toja11],[P1jtojp1a10,P1jtojp1a11])
        # LimP2(Pjm2j,Pjm1jp1,Pjjp2,Pjm2jp2,Pjm1j,Pjjp1)
        # Ra0 = qaj - Ra2/3*(dx/2)**2
        RccP2  = Ra2*(xplot - x[i])**2 + Ra1*(xplot - x[i]) + Ra0
        print('Second Order')
        ...
        print()
        print('ReconCC %2.12f %2.12f %2.12f'%(Ra0,Ra1,Ra2))
        print()
        print()
        ...
        if i == nG:
            ...
            # # plot(xplot, RccjP, '-',color ='green',label='New Way', linewidth= lw)
            plot(xplot, RMMP , '-',color ='red',label='MinMod', linewidth= lw)
            ...
            plot(xplot, RccP2 , '-',color ='blue',label='P2 CC', linewidth= lw)
            ...
            # plot(xplot, RccjP, '-',color ='green', linewidth= lw)
            plot(xplot, RMMP , '-',color ='red', linewidth= lw)
            
            plot(xplot, RccP2 , '-',color ='blue', linewidth= lw)
