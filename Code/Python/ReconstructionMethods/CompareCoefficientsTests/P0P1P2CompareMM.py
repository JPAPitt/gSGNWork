...
def LimP2(Pjm2j,Pjm1jp1,Pjjp2,Pjm2jp2):
    
    QqFull = [Pjm2j,Pjm1jp1,Pjjp2]
    if (CompareCoeffsSign(QqFull)):
        return minmodL([Pjm2j[0],Pjm1jp1[0],Pjjp2[0],Pjm2jp2[0]]),minmodL([Pjm2j[1],Pjm1jp1[1],Pjjp2[1],Pjm2jp2[1]])
    else:
        Qqnojm2 = [Pjm1jp1,Pjjp2]
        Qqnojp2 = [Pjm2j,Pjm1jp1]
        
        
        if CompareCoeffsSign(Qqnojm2):
            return minmodL([Pjm2j[0],Pjm1jp1[0]]),minmodL([Pjm2j[1],Pjm1jp1[1]])
        elif CompareCoeffsSign(Qqnojp2):
            return minmodL([Pjm2j[0],Pjm1jp1[0]]),minmodL([Pjm2j[1],Pjm1jp1[1]])
        else:
            return 0,0
...
def PlotBuildUpToQuad(x,q,dx,nG,np):
    ...
    for i in range(nG,n-nG):
        ...
        RMMP = minmodL([P1jm1toja11,0.5*(P1jm1toja11+ P1jtojp1a11),P1jtojp1a11])*(xplot - x[i]) + qaj
        ...
        Ra1,Ra2 = LimP2([P2jm2toja21,P2jm2toja22],[P2jm1tojp1a21,P2jm1tojp1a22],[P2jtojp2a21,P2jtojp2a22],[P4a1,P4a2])
        ...
        print()
        print('ReconMM %2.12f %2.12f'%(qaj,minmodL([P1jm1toja11,0.5*(P1jm1toja11+ P1jtojp1a11),P1jtojp1a11])))
        print('Second Order')
