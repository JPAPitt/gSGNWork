...
def PlotBuildUpToQuad(x,q,dx,nG,np):
    ...
    for i in range(nG,n-nG):
        ...
        DP2jm2tojAtm5h = 2*P2jm2toja22*(-5*dx/2) +  P2jm2toja21
        DP2jm2tojAtph = 2*P2jm2toja22*(dx/2) +  P2jm2toja21
        qjm2tojMon = Monotone([qajm2,qajm1,qaj])
        SSjm2tojE = (sign(DP2jm2tojAtm5h) == sign(DP2jm2tojAtph))
        
        DP2jm2tojAtm7h = 2*P2jm2toja22*(-7*dx/2) +  P2jm2toja21
        DP2jm2tojAtp7h = 2*P2jm2toja22*(-7*dx/2) +  P2jm2toja21
        SSjm2tojExp = (sign(DP2jm2tojAtm7h) == sign(DP2jm2tojAtp7h))

        DP2jm1tojp1Atm3h = 2*P2jm1tojp1a22*(-3*dx/2) +  P2jm1tojp1a21
        DP2jm1tojp1Atp3h = 2*P2jm1tojp1a22*(3*dx/2) +  P2jm1tojp1a21
        qjm1tojp1Mon = Monotone([qajm1,qaj,qajp1])
        SSjm1tojp1E = sign(DP2jm1tojp1Atm3h) == sign(DP2jm1tojp1Atp3h)


        DP2jm1tojp1Atm7h = 2*P2jm1tojp1a22*(-7*dx/2) +  P2jm1tojp1a21
        DP2jm1tojp1Atp7h = 2*P2jm1tojp1a22*(7*dx/2) +  P2jm1tojp1a21
        SSjm1tojp1Exp = (sign(DP2jm1tojp1Atm7h) == sign(DP2jm1tojp1Atp7h))

        DP2jtojp2Atmh = 2*P2jtojp2a22*(-dx/2) +  P2jtojp2a21
        DP2jtojp2Atp5h = 2*P2jtojp2a22*(5*dx/2) +  P2jtojp2a21
        qjtojp2Mon = Monotone([qaj,qajp1,qajp2])
        SSjtojp2E = sign(DP2jtojp2Atmh) == sign(DP2jtojp2Atp5h)

        DP2jtojp2Atm7h = 2*P2jtojp2a22*(-7*dx/2) +  P2jtojp2a21
        DP2jtojp2Atp7h = 2*P2jtojp2a22*(7*dx/2) +  P2jtojp2a21
        SSjtojp2Exp = (sign(DP2jtojp2Atm7h) == sign(DP2jtojp2Atp7h))
        
        qjm3tojp3Mon = Monotone([qajm3,qajm2,qajm1,qaj,qajp1,qajp2,qajp3])
        
        print(i,qajm3,qajm2,qajm1,qaj,qajp1,qajp2,qajp3)
        print(i,xmh,xph,'P2 j-2,j   LED,RED',DP2jm2tojAtm5h,DP2jm2tojAtph,SSjm2tojExp,qjm3tojp3Mon)
        print(i,xmh,xph,'P2 j-1,j+1 LED,RED',DP2jm1tojp1Atm3h,DP2jm1tojp1Atp3h,SSjm1tojp1Exp,qjm3tojp3Mon)
        print(i,xmh,xph,'P2 j,j+2   LED,RED',DP2jtojp2Atmh,DP2jtojp2Atp5h,SSjtojp2Exp,qjm3tojp3Mon)
 

        Pjm2tojLEV,Pjm2tojREV =   EdgeValuesPjm2j(qajm2,qajm1,qaj)
        Pjm1tojp1LEV,Pjm1tojp1REV = EdgeValuesPjm1jp1(qajm1,qaj,qajp1)
        Pjtojp2LEV,Pjtojp2REV =  EdgeValuesPjjp2(qaj,qajp1,qajp2)
        
        MaxPjm2tojV,MaxPjm2tojL =  MaxP2Coeffs(P2jm2toja22,P2jm2toja21,P2jm2toja20)
        MaxPjm1tojp1V,MaxPjm1tojp1L =  MaxP2Coeffs(P2jm1tojp1a22,P2jm1tojp1a21,P2jm1tojp1a20)
        MaxPjtojp2V,MaxPjtojp2L =  MaxP2Coeffs(P2jtojp2a22,P2jtojp2a21,P2jtojp2a20)
        
        print(i,xmh,xph,'Edge Values j',Pjm2tojLEV,Pjm2tojREV, Pjm1tojp1LEV,Pjm1tojp1REV,Pjtojp2LEV,Pjtojp2REV)
        MaxEV = max(Pjm2tojLEV,Pjm2tojREV, Pjm1tojp1LEV,Pjm1tojp1REV,Pjtojp2LEV,Pjtojp2REV)
        MinEV = min(Pjm2tojLEV,Pjm2tojREV, Pjm1tojp1LEV,Pjm1tojp1REV,Pjtojp2LEV,Pjtojp2REV)
        print(i,xmh,xph,'Max / Min Edge Values j',MaxEV,MinEV)
        print(i,xmh,xph,'Extrema Values j',MaxPjm2tojV,MaxPjm2tojL,MaxPjm1tojp1V,MaxPjm1tojp1L,MaxPjtojp2V,MaxPjtojp2L,-dx/2,dx/2)
        
        MaxMinConstrained = []
        
        if abs(MaxPjm2tojL) < dx/2:
            MaxMinConstrained.append(MaxPjm2tojV)
        if abs(MaxPjm1tojp1L) < dx/2:
            MaxMinConstrained.append(MaxPjm1tojp1V)
        if abs(MaxPjtojp2L) < dx/2:
            MaxMinConstrained.append(MaxPjtojp2V)
        if (len(MaxMinConstrained) > 0):
            print(i,xmh,xph,'Max / Min Extrema Values j',max(MaxMinConstrained), min(MaxMinConstrained))
        ...
        Ra1 = 0
        Ra0 = qaj
        if ((SSjm2tojExp and qjm3tojp3Mon) ):
            Ra2 = P2jm2toja22
            Ra1 = P2jm2toja21
            Ra0 = P2jm2toja20

        if ((SSjtojp2Exp and qjm3tojp3Mon) ):
            Ra2 = P2jtojp2a22
            Ra1 = P2jtojp2a21
            Ra0 = P2jtojp2a20
        
        if ((SSjm1tojp1Exp and qjm3tojp3Mon ) ):
            Ra2 = P2jm1tojp1a22
            Ra1 = P2jm1tojp1a21
            Ra0 = P2jm1tojp1a20
