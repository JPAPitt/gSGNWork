...
def PlotBuildUpToQuad(x,q,dx,nG,np):
    ...
    for i in range(nG,n-nG):
        ...
        # P1Ra1 = w1a1*P1jm1toja11 + w2a1*P1jtojp1a11
        # P1Ra0 = qaj
        ...
        iw1a2 = ((-1.0/8.0) / (eps +P2jm2tojSI )**2)
        iw2a2 = ((10.0/8.0) / (eps +P2jm1tojp1SI )**2)
        iw3a2 = ((-1.0/8.0)  / (eps +P2jtojp2SI )**2)
            
        
        w1a2 = iw1a2 / (iw1a2 + iw2a2 + iw3a2)
        w2a2 = iw2a2 / (iw1a2 + iw2a2 + iw3a2)
        w3a2 = iw3a2 / (iw1a2 + iw2a2 + iw3a2)
        
        NSIjm2j =1 -  P2jm2tojSI / (P2jm2tojSI + P2jm1tojp1SI + P2jtojp2SI )
        NSIjm1jp1 =1 -  P2jm1tojp1SI / (P2jm2tojSI + P2jm1tojp1SI + P2jtojp2SI )
        NSIjjp2 = 1-  P2jtojp2SI / (P2jm2tojSI + P2jm1tojp1SI + P2jtojp2SI )
        
        Noptjm2j = (-1.0/8.0) 
        Noptjm1jp1 = (10.0/8.0)
        Noptjjp2 =  (-1.0/8.0)        
        Ra2 = w1a2*P2jm2toja22 + w2a2*P2jm1tojp1a22 + w3a2*P2jtojp2a22
        
        print(i,xmh,xph,'NSI',NSIjm2j,NSIjm1jp1,NSIjjp2)
        print(i,xmh,xph,'NW',NSIjm2j*Noptjm2j,NSIjm1jp1*Noptjm1jp1,NSIjjp2*Noptjjp2, NSIjm2j*Noptjm2j+NSIjm1jp1*Noptjm1jp1+NSIjjp2*Noptjjp2)
        print(i,xmh,xph,'Coeffs',P2jm2toja22,P2jm1tojp1a22,P2jtojp2a22,Ra2)
        
        iw1a1 = ((5.0/24.0) / (eps +P2jm2tojSI )**2)
        iw2a1 = ((14.0/24.0) / (eps +P2jm1tojp1SI )**2)
        iw3a1 = ((5.0/24.0)  / (eps +P2jtojp2SI )**2)
    
        
        w1a1 = iw1a1 / (iw1a1 + iw2a1 + iw3a1)
        w2a1 = iw2a1 / (iw1a1 + iw2a1 + iw3a1)
        w3a1 = iw3a1 / (iw1a1 + iw2a1 + iw3a1)

        
        Ra1 = w1a1*P2jm2toja21 + w2a1*P2jm1tojp1a21 + w3a1*P2jtojp2a21

        print(i,xmh,xph,'weights',iw1a1,iw2a1,iw3a1)
        print(i,xmh,xph,'weights',w1a1,w2a1,w3a1)
        print(i,xmh,xph,'Coeffs',P2jm2toja21,P2jm1tojp1a21,P2jtojp2a21,Ra1)
        
        # iw1a0 = ((-9.0/80.0) / (eps +P2jm2tojSI )**2)
        # iw2a0 = ((98.0/80.0) / (eps +P2jm1tojp1SI )**2)
        # iw3a0 = ((-9.0/80.0)  / (eps +P2jtojp2SI )**2)
    
        
        # w1a0 = iw1a0 / (iw1a0 + iw2a0 + iw3a0)
        # w2a0 = iw2a0 / (iw1a0 + iw2a0 + iw3a0)
        # w3a0 = iw3a0 / (iw1a0 + iw2a0 + iw3a0)
        
        # Ra0 = w1a0*P2jm2toja20 + w2a0*P2jm1tojp1a20 + w3a0*P2jtojp2a20
        Ra0 = qaj - Ra2/3*(dx/2)**2  
        
        # print(i,xmh,xph,w1a0,w2a0,w3a0,P2jm2toja20,P2jm1tojp1a20,P2jtojp2a20,Ra0)
        ...
        # P2P1Ra2 = w1a2*P2jm2toja22 + w2a2*P2jm1tojp1a22 + w3a2*P2jtojp2a22
        # P2P1Ra1 = w1a1*P2jm2toja21 + w2a1*P1Ra1 + w3a1*P2jtojp2a21
        # P2P1Ra0 = w1a0*P2jm2toja20 + w2a0*P2jm1tojp1a20 + w3a0*P2jtojp2a20

        # LimP2RP =  P2P1Ra2*(xplot - x[i])**2 + P2P1Ra1*(xplot - x[i])   +P2P1Ra0
        ...
        # RIxjph = P2P1Ra2/3*(dx/2)**3 + P2P1Ra1/2*(dx/2)**2 + P2P1Ra0*(dx/2)
        # RIxjmh = P2P1Ra2/3*(-dx/2)**3 + P2P1Ra1/2*(-dx/2)**2 + P2P1Ra0*(-dx/2)
        # print(i,xmh,xph,'CA', (RIxjph -  RIxjmh)/dx,qaj,(RIxjph -  RIxjmh)/dx-qaj )
        ...
        if i == nG:
            ...
            # plot(xplot, LimP2RP, '-r',label='Recon Weno P1P2 j-1,j+1')
            plot(xplot, LimP2R, '-y',label='Recon Weno P2 j-1,j+1')

        else:
            plot(xplot, P0jplot, '-b')   
            # plot(xplot, P1jm1jP, '-r')
            # plot(xplot, P1jjp1P, '-g')
            # plot(xplot, LimP2RP, '-r')
            plot(xplot, LimP2R, '-y')
