...
def PlotBuildUpToQuad(x,q,dx,nG,np):
    ...
    for i in range(nG,n-nG):
        ...
        # print(i,xmh,xph,'SI - 1 -',P1jtojp1SI,P1jm1tojSI)
        #To left is more smooth
        if P1jtojp1SI > P1jm1tojSI:
            ...
            R2a1 = P1jm1toja11 + dx*R2a2
            R2a0 = P1jm1toja10 - dx**2/12*R2a2
           
            # print(i,xmh,xph,'Look Left -',P2jm2tojSI,P2jm1tojp1SI)
        #To right is more smooth
            ...
            P2jm1tojp1a22,P2jm1tojp1a21,P2jm1tojp1a20,P2jm1tojp1SI  = P2jm1tojp1(qajp1,qaj,qajm1,dx)
            # print(i,xmh,xph,'Look Right -',P2jtojp2SI,P2jm1tojp1SI )
            ...
            R2a1 = P1jtojp1a11 - dx*R2a2
            R2a0 = P1jtojp1a10  - dx**2/12*R2a2
...
# BVjm1toj = P1jm1toj +  P2jm1tojp1Coefficients[-1]*(xmxj**2 + dx*xmxj - dx**2/12)
        #Equal smoothness each way    
        else:
            P2jtojp2a22,P2jtojp2a21,P2jtojp2a20,P2jtojp2SI =   P2jtojp2(qaj,qajp1,qajp2,dx) 
            P2jm1tojp1a22,P2jm1tojp1a21,P2jm1tojp1a20,P2jm1tojp1SI  = P2jm1tojp1(qajp1,qaj,qajm1,dx)
            P2jm2toja22,P2jm2toja21,P2jm2toja20,P2jm2tojSI = P2jm2toj(qajm2,qajm1,qaj,dx)   
            # print(i,xmh,xph,'Equal -',P2jm2tojSI,P2jm1tojp1SI,P2jtojp2SI)
            if(P2jtojp2SI == P2jm2tojSI and P2jm1tojp1SI < P2jm2tojSI  ):
                R2a2 = P2jm1tojp1a22
                R2a1 = P1jtojp1a11 - dx*R2a2
                R2a0 = P1jtojp1a10  - dx**2/12*R2a2
            elif(P1jtojp1a11 == P1jm1toja11 ):
                R2a2 = 0
                R2a1 = P1jtojp1a11
                R2a0 = P1jtojp1a10
            else:
