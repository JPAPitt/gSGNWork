...
def PlotBuildUpToQuad(x,q,dx,nG,np):
    ...
    for i in range(nG,n-nG):
        ...
        LimP2Plotjm1tojp1 = P2jm1tojp1a22*(xplot - x[i])**2 + P2jm1tojp1a21*(xplot - x[i])   +P2jm1tojp1a20
        # LimP2Plotjm1tojp1 = P2jm1tojp1a21*(xplot - x[i])   +P2jm1tojp1a20
        ...
        if (min(P2jtojp2SI ,P2jm2tojSI,P4jm2tojp2SI,P1jtojp1SI,P1jm1tojSI,P2jm1tojp1SI) < 10**-12):
            if (min(P1jtojp1SI,P1jm1tojSI,P2jm1tojp1SI) < 10**-12):
                P2Ra4 = 0
                P2Ra3 = 0
                P2Ra2 = 0
        ...
        # TotalSI =  (P2jtojp2SI + P2jm2tojSI + P4jm2tojp2SI )
        # if TotalSI > 10.0**(-12):
        ...
        # print(i,xmh,xph,'Smoothness 1st',P1jm1tojSI,P1jtojp1SI,P2jm1tojp1SI)
        # print(i,xmh,xph,'Smoothness Weights 1st',(P1jtojp1SI +P2jm1tojp1SI  )/TotalSI,((P1jm1tojSI +P1jtojp1SI )/TotalSI),((P1jm1tojSI +P2jm1tojp1SI  )/TotalSI))
        # print(i,xmh,xph,'Smoothness 2nd',P2jtojp2SI,P2jm2tojSI,P4jm2tojp2SI)
        # print(i,xmh,xph,'Smoothness Weights ',((P4jm2tojp2SI + P2jtojp2SI) /TotalSI), ((P2jm2tojSI +P2jtojp2SI )/TotalSI),((P2jm2tojSI + P4jm2tojp2SI)/TotalSI) )
        
        # LimP1R =  + P1Ra1*(xplot - x[i])   +P1Ra0
        # #Quadratic
        # P2jtojp2a22,P2jtojp2a21,P2jtojp2a20,P2jtojp2SI =   P2jtojp2(qaj,qajp1,qajp2,dx)
        # P2jm2toja22,P2jm2toja21,P2jm2toja20,P2jm2tojSI = P2jm2toj(qajm2,qajm1,qaj,dx)   
        # P4jm2tojp2a44,P4jm2tojp2a43,P4jm2tojp2a42,P4jm2tojp2a41,P4jm2tojp2a40,P4jm2tojp2SI = P4jm2tojp2(qajm2,qajm1,qaj,qajp1,qajp2,dx)  
        ...
        # P6jm3tojp3a,P6jm3tojp3b,P6jm3tojp3c,P6jm3tojp3d,P6jm3tojp3e,P6jm3tojp3f,P6jm3tojp3g,P6jm3tojp3SI  = P6jm3tojp3(qajm3,qajm2,qajm1,qaj,qajp1,qajp2,qajp3,dx)
        
        # TotalSI =  (P1jtojp1SI + P1jm1tojSI +P2jm1tojp1SI)
        # if TotalSI > 10.0**(-12):
        #     P1Ra1 = (P1jm1tojSI /TotalSI)*P1jm1toja11 + (P2jm1tojp1SI/TotalSI)*P2jm1tojp1a21 + (P1jtojp1SI/TotalSI)*P1jtojp1a11 
        #     P1Ra0 = (P1jm1tojSI /TotalSI)*P1jm1toja10 + (P2jm1tojp1SI/TotalSI)*P2jm1tojp1a20 + (P1jtojp1SI/TotalSI)*P1jtojp1a10
        # else:
        #     P1Ra1 = 0
        #     P1Ra0 = qaj
        ...
        # print (i,xmh,xph,'SI',P2jtojp2SI,P2jm2tojSI,P4jm2tojp2SI)
        # print(i,xmh,xph,'SI D',(P2jtojp2SI+ P4jm2tojp2SI) /TotalSI,(P2jtojp2SI+ P2jm2tojSI ) /TotalSI,(P2jm2tojSI + P4jm2tojp2SI) /TotalSI , (P2jtojp2SI+ P4jm2tojp2SI) /TotalSI+(P2jtojp2SI+ P2jm2tojSI ) /TotalSI+(P2jm2tojSI + P4jm2tojp2SI) /TotalSI )
        # print(i,xmh,xph,'Coeffs 4',P4jm2tojp2a44)
        # print(i,xmh,xph,'Coeffs 3',P4jm2tojp2a43)
        # print(i,xmh,xph,'Coeffs 2',P2jtojp2a22, P2jm2toja22,P4jm2tojp2a42)
        # print(i,xmh,xph,'Coeffs 1',P2jtojp2a21, P2jm2toja21,P4jm2tojp2a41)
        # print(i,xmh,xph,'Coeffs 0',P2jtojp2a20, P2jm2toja20,P4jm2tojp2a40)       
        # print(i,xmh,xph,'Coeffs 2 W', ((P2jtojp2SI+ P4jm2tojp2SI) /TotalSI)*P2jm2toja22 , ((P2jtojp2SI+ P2jm2tojSI ) /TotalSI)*P4jm2tojp2a42 ,  ((P2jm2tojSI + P4jm2tojp2SI) /TotalSI)*P2jtojp2a22)
        # print(i,xmh,xph,'Coeffs 1 W',((P2jtojp2SI+ P4jm2tojp2SI) /TotalSI)*P2jm2toja21 , ((P2jtojp2SI+ P2jm2tojSI ) /TotalSI)*P4jm2tojp2a41 ,  ((P2jm2tojSI + P4jm2tojp2SI) /TotalSI)*P2jtojp2a21)
        # print(i,xmh,xph,'Coeffs 0 W',((P2jtojp2SI+ P4jm2tojp2SI) /TotalSI)*P2jm2toja20 , ((P2jtojp2SI+ P2jm2tojSI ) /TotalSI)*P4jm2tojp2a40 ,  ((P2jm2tojSI + P4jm2tojp2SI) /TotalSI)*P2jtojp2a20)               
        
        # TotalSI =  (Bjm3toj  +Bjtojp3 + P6jm3tojp3SI )*2.0
        # if TotalSI > 10.0**(-12):
        #     P3Ra3 = ((Bjtojp3 + P6jm3tojp3SI) /TotalSI)*pjm3toja + ((Bjtojp3 + Bjm3toj) /TotalSI)*P6jm3tojp3d  + ((Bjm3toj+ P6jm3tojp3SI) /TotalSI)*pjtojp3a
                    
        #     P3Ra2 = ((Bjtojp3+ P6jm3tojp3SI) /TotalSI)*pjm3tojb+ ((Bjtojp3 + Bjm3toj) /TotalSI)*P6jm3tojp3e  + ((Bjm3toj+ P6jm3tojp3SI) /TotalSI)*pjtojp3b                     
                     
        #     P3Ra1 = ((Bjtojp3+ P6jm3tojp3SI) /TotalSI)*pjm3tojc + ((Bjtojp3 + Bjm3toj) /TotalSI)*P6jm3tojp3f  + ((Bjm3toj+ P6jm3tojp3SI) /TotalSI)*pjtojp3c

        #     P3Ra0 = ((Bjtojp3+ P6jm3tojp3SI) /TotalSI)*pjm3tojd + + ((Bjtojp3 + Bjm3toj) /TotalSI)*P6jm3tojp3g  + ((Bjm3toj+ P6jm3tojp3SI) /TotalSI)*pjtojp3d
