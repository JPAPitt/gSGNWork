...
def PlotBuildUpToQuad(x,q,dx,nG,np):
    ...
    for i in range(nG,n-nG):
        ...
        if (abs(P1jtojp1SI -P1jm1tojSI) < 10.0**(-12)):
            I1 = 0
        ...
        # # BasisInterpjm3toj = P3jm3tojCoefficients[-1]*(xmxj**3 + 3*dx*xmxj**2 + 7*dx**2/4*xmxj - dx**3/4) 

       
        #Right
        if I1 == 1:
            if(P4jm2tojp2SI > P3jtojp3SI ):
                Ra3 = P3jtojp3a33
            else:
                Ra3 = P4jm2tojp2a43
            Ra2 = Ra2 - 3*dx*Ra3
        ...
        #undecided
             ...
             if((P4jm2tojp2SI < P3jm3tojSI  or P4jm2tojp2SI < P3jtojp3SI  ) ):
                 Ra3 =P4jm2tojp2a43
                 Ra2 =P4jm2tojp2a42
                 Ra1 =P4jm2tojp2a41
                 Ra0 = P4jm2tojp2a40
             elif((P2jm1tojp1SI < P2jm2tojSI or P2jm1tojp1SI < P2jtojp2SI  ) ):
                 Ra3 =0
                 Ra2 = P2jm1tojp1a22
                 Ra1 = P2jm1tojp1a21
                 Ra0 = P2jm1tojp1a20
        ...
        print(i,xmh,xph,I1,' 3 SI:',P3jtojp3SI,P3jm3tojSI,P4jm2tojp2SI ,  P3jtojp3SI-P3jm3tojSI)
        print(i,xmh,xph,I1,' 2 SI:',P2jtojp2SI,P2jm2tojSI,P2jm1tojp1SI)
        print(i,xmh,xph,I1,' 1 SI:',P1jtojp1SI,P1jm1tojSI)
        # #Cubics
        # P3jm3toja33,P3jm3toja32,P3jm3toja31,P3jm3toja30,P3jm3tojSI = P3jm3toj(qaj,qajm1,qajm2,qajm3,dx)
        # P3jtojp3a33,P3jtojp3a32,P3jtojp3a31,P3jtojp3a30,P3jtojp3SI = P3jtojp3(qaj,qajp1,qajp2,qajp3,dx)
        ...
        # print(i,xmh,xph,I1,'SI:',P3jm3tojSI ,P3jm2tojp1SI,P3jm1tojp2SI,P3jtojp3SI , P3jm3tojSI - P3jtojp3SI )
        # print(i,xmh,xph,I1,Ra0,Ra1,Ra2)


        # LimP1R = Ra1*(xplot - x[i])   +Ra0
        # LimP2R = Ra2*(xplot - x[i])**2 + Ra1*(xplot - x[i])   +Ra0
        LimP3R = Ra3*(xplot - x[i])**3 + Ra2*(xplot - x[i])**2 + Ra1*(xplot - x[i])   +Ra0
        ...
        if i == nG:
            ...
            # plot(xplot, LimP1R, '-g',label='Recon P1')
            # plot(xplot, LimP2R, '-r',label='Recon P2')
            plot(xplot, LimP3R, '-y',label='Recon P3')
