...
def PlotBuildUpToQuad(x,q,dx,nG,np):
    ...
    for i in range(nG,n-nG):
        ...
        # if(P2jtojp2SI==P2jm1tojp1SI and P2jm1tojp1SI == P2jm2tojSI   ):
        ...
        # if(P2jtojp2SI==min(P2jtojp2SI,P2jm1tojp1SI,P2jm2tojSI) ):
            
        #     P2Ra2 =  P2jtojp2a22
        #     P2Ra1 =  P2jtojp2a21
        #     P2Ra0 =  P2jtojp2a20
        #     P2RSI = P2jtojp2SI
        # elif(P2jm1tojp1SI==min(P2jtojp2SI,P2jm1tojp1SI,P2jm2tojSI) ):
        #     P2Ra2 =  P2jm1tojp1a22
        #     P2Ra1 =  P2jm1tojp1a21
        #     P2Ra0 =  P2jm1tojp1a20 
        #     P2RSI = P2jm1tojp1SI
        ...
        P0E =  mean([abs(P0ja0 - q[i-3]),abs(P0ja0 - q[i-2]),abs(P0ja0 - q[i-1]),abs(P0ja0 - q[i]), abs(P0ja0 - q[i+1]), abs(P0ja0 - q[i+2]), abs(P0ja0 - q[i+3]) ]) 
        
        P1RLE = PolyIntegralError(-7*dx/2,-5*dx/2,q[i-3],dx,(P1Ra0,P1Ra1))
        P1RRE = PolyIntegralError(5*dx/2,7*dx/2,q[i+3],dx,(P1Ra0,P1Ra1))
        
        P1E =  mean([PolyIntegralError(-7*dx/2,-5*dx/2,q[i-3],dx,(P1Ra0,P1Ra1)), \
                     PolyIntegralError(-5*dx/2,-3*dx/2,q[i-2],dx,(P1Ra0,P1Ra1)), \
                     PolyIntegralError(-3*dx/2,-dx/2,q[i-1],dx,(P1Ra0,P1Ra1)) ,\
                     PolyIntegralError(-dx/2,dx/2,q[i],dx,(P1Ra0,P1Ra1)) ,\
                     PolyIntegralError(dx/2,3*dx/2,q[i+1],dx,(P1Ra0,P1Ra1)) ,\
                     PolyIntegralError(3*dx/2,5*dx/2,q[i+2],dx,(P1Ra0,P1Ra1)) ,\
                     PolyIntegralError(5*dx/2,7*dx/2,q[i+3],dx,(P1Ra0,P1Ra1)) ]) 

        P2RLE = PolyIntegralError(-7*dx/2,-5*dx/2,q[i-3],dx,(P2Ra0,P2Ra1,P2Ra2))
        P2RRE = PolyIntegralError(5*dx/2,7*dx/2,q[i+3],dx,(P2Ra0,P2Ra1,P2Ra2))


        P2E =  mean([PolyIntegralError(-7*dx/2,-5*dx/2,q[i-3],dx,(P2Ra0,P2Ra1,P2Ra2)), \
                     PolyIntegralError(-5*dx/2,-3*dx/2,q[i-2],dx,(P2Ra0,P2Ra1,P2Ra2)), \
                     PolyIntegralError(-3*dx/2,-dx/2,q[i-1],dx,(P2Ra0,P2Ra1,P2Ra2)) ,\
                     PolyIntegralError(-dx/2,dx/2,q[i],dx,(P2Ra0,P2Ra1,P2Ra2)) ,\
                     PolyIntegralError(dx/2,3*dx/2,q[i+1],dx,(P2Ra0,P2Ra1,P2Ra2)) ,\
                     PolyIntegralError(3*dx/2,5*dx/2,q[i+2],dx,(P2Ra0,P2Ra1,P2Ra2)) ,\
                     PolyIntegralError(5*dx/2,7*dx/2,q[i+3],dx,(P2Ra0,P2Ra1,P2Ra2)) ]) 

        print(i,xmh,xph,'Recon P0  (j)',P0E)
        print(i,xmh,xph,'Recon P1  (j)',P1E)
        print(i,xmh,xph,'Recon P2  (j)',P2E)
