...
def PlotBuildUpToQuad(x,q,dx,nG,np):
    ...
    for i in range(nG,n-nG):
        ...
        #Left Indicator
        P1jtojp1LEjm1 =  P1jtojp1a11/2*(-3*dx/2)**2 + P1jtojp1a10*(-3*dx/2)
        P1jtojp1REjm1 =  P1jtojp1a11/2*(-dx/2)**2 + P1jtojp1a10*(-dx/2)
        P1jtojp1Ejm1 = (P1jtojp1REjm1 - P1jtojp1LEjm1)/ dx - qajm1
        
        #Right Indicator
        P1jtojp1LEjp2 =  P1jtojp1a11/2*(3*dx/2)**2 + P1jtojp1a10*(3*dx/2)
        P1jtojp1REjp2 =  P1jtojp1a11/2*(5*dx/2)**2 + P1jtojp1a10*(5*dx/2)
        P1jtojp1Ejp2 = (P1jtojp1REjp2 - P1jtojp1LEjp2)/ dx - qajp2

        #Right Indicator
        P1jm1tojLEjp1 =  P1jm1toja11/2*(dx/2)**2 + P1jm1toja10*(dx/2)
        P1jm1tojREjp1 =  P1jm1toja11/2*(3*dx/2)**2 + P1jm1toja10*(3*dx/2)
        P1jm1tojEjp1 = (P1jm1tojREjp1 - P1jm1tojLEjp1)/ dx - qajp1        

        P1jm1tojLEjm2 =  P1jm1toja11/2*(-5*dx/2)**2 + P1jm1toja10*(-5*dx/2)
        P1jm1tojREjm2 =  P1jm1toja11/2*(-3*dx/2)**2 + P1jm1toja10*(-3*dx/2)
        P1jm1tojEjm2 = (P1jm1tojREjm2 - P1jm1tojLEjm2)/ dx - qajm2    
        
        print(i,xmh,xph,'P1 j,j+1 Info',P1jtojp1SI,P1jtojp1Ejm1,P1jtojp1Ejp2)
        print(i,xmh,xph,'P1 j-1,j Info',P1jm1tojSI,P1jm1tojEjm2,P1jm1tojEjp1)
        print(i,xmh,xph,'ExpWorst',P1jtojp1Ejm1 -P1jm1tojEjp1 )
        print(i,xmh,xph,'ExpBest',P1jm1tojEjm2 -P1jtojp1Ejp2)
        # print(i,xmh,xph,'P1 j,j+1 Info',P1jtojp1SI,max(P1jtojp1Ejm1,P1jtojp1Ejp2))
        # print(i,xmh,xph,'P1 j-1,j Info',P1jm1tojSI,max(P1jm1tojEjm2,P1jm1tojEjp1))
        
        if (abs(P1jtojp1Ejm1 -P1jm1tojEjp1 ) < 10.0**(-16)):
            if( abs(P1jtojp1SI - P1jm1tojSI) < 10.0**(-16)) :
                Ra1 =0
                Ra0 = qaj
                ...
                Ra1 =P1jm1toja11
                Ra0 =P1jm1toja10
        elif(P1jtojp1Ejm1 <  P1jm1tojEjp1 ):
            Ra1 =P1jtojp1a11 
            Ra0 =P1jtojp1a10
        else:
            Ra1 =P1jm1toja11
        ...
        RP1 =Ra1*(xplot - x[i]) + Ra0  
        if i == nG:
            # plot(xplot, P0jplot, '-b',label='Recon P0')   
            
            plot(xplot, P1jtojp1P, '-b',label='P1 j,j+1')
            plot(xplot, P1jm1tojP , '-r',label='P1 j-1,j')
            plot(xplot, RP1,'-g',label='Recon')
        else:
            plot(xplot, P1jtojp1P, '-b')
            plot(xplot, P1jm1tojP , '-r')
            plot(xplot, RP1,'-g')
