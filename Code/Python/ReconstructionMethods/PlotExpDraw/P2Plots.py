...
def PlotBuildUpToQuad(x,q,dx,nG,np):
    ...
    for i in range(nG,n-nG):
        ...
        Avga22 = 0.5*(P2jm2toja22 -P2jtojp2a22 )
        Avga21 = 0.5*(P2jm2toja21  + P2jtojp2a21)
        Avga20 = qaj

        if (P2jm2tojSI < min(P2jm1tojp1SI,P2jtojp2SI)):
            Ra2 = P2jm2toja22
            Ra1 = P2jm2toja21
            Ra0 = P2jm2toja20
        elif ( P2jm1tojp1SI < min(P2jm2tojSI,P2jtojp2SI)):
            Ra2 = P2jm1tojp1a22
            Ra1 = P2jm1tojp1a21
            Ra0 = P2jm1tojp1a20
        elif ( P2jtojp2SI < min(P2jm2tojSI,P2jm1tojp1SI)):
            Ra2 = P2jtojp2a22
            Ra1 = P2jtojp2a21
            Ra0 = P2jtojp2a20  
        else:
            Ra2 = 0.5*(P2jm2toja22 -P2jtojp2a22 )
            Ra1 = 0.5*(P2jm2toja21  + P2jtojp2a21)
            Ra0 = qaj    
        print(i,xmh,xph,'SI',P1jtojp1SI, P1jm1tojSI)    
        print(i,xmh,xph,'P2 j-2,j:',P2jm2toja22,P2jm2toja21,P2jm2toja20,P2jm2tojSI )
        print(i,xmh,xph,'P2 j-1,j+1:',P2jm1tojp1a22,P2jm1tojp1a21,P2jm1tojp1a20,P2jm1tojp1SI )
        print(i,xmh,xph,'P2 j,j+2:',P2jtojp2a22,P2jtojp2a21,P2jtojp2a20,P2jtojp2SI )
        ...
        P2jtojp2jm1LE = P2jtojp2a22/3*(-3*dx/2)**3 + P2jtojp2a21/2*(-3*dx/2)**2  +P2jtojp2a20*(-3*dx/2)
        P2jtojp2jm1RE = P2jtojp2a22/3*(-dx/2)**3 + P2jtojp2a21/2*(-dx/2)**2  +P2jtojp2a20*(-dx/2)
        EP2jtojp2jm1 = abs((P2jtojp2jm1RE - P2jtojp2jm1LE)/ dx - qajm1)
        
        P2jtojp2jm2LE = P2jtojp2a22/3*(-5*dx/2)**3 + P2jtojp2a21/2*(-5*dx/2)**2  +P2jtojp2a20*(-5*dx/2)
        P2jtojp2jm2RE = P2jtojp2a22/3*(-3*dx/2)**3 + P2jtojp2a21/2*(-3*dx/2)**2  +P2jtojp2a20*(-3*dx/2)
        EP2jtojp2jm2 = abs((P2jtojp2jm2RE - P2jtojp2jm2LE)/ dx - qajm2)
        
        print(i,xmh,xph,'P2 j-1,j-2 Errors:',EP2jtojp2jm1,EP2jtojp2jm2 )

        
        P2jm2tojjp1LE = P2jm2toja22/3*(dx/2)**3 + P2jm2toja21/2*(dx/2)**2  + P2jm2toja20*(dx/2)
        P2jm2tojjp1RE = P2jm2toja22/3*(3*dx/2)**3 + P2jm2toja21/2*(3*dx/2)**2  + P2jm2toja20*(3*dx/2)
        EP2jm2tojjp1 = abs((P2jm2tojjp1RE - P2jm2tojjp1LE)/ dx - qajp1)
        
        P2jm2tojjp2LE = P2jm2toja22/3*(3*dx/2)**3 + P2jm2toja21/2*(3*dx/2)**2  + P2jm2toja20*(3*dx/2)
        P2jm2tojjp2RE = P2jm2toja22/3*(5*dx/2)**3 + P2jm2toja21/2*(5*dx/2)**2  + P2jm2toja20*(5*dx/2)
        EP2jm2tojjp2 = abs((P2jm2tojjp2RE - P2jm2tojjp2LE)/ dx - qajp2)
        
        print(i,xmh,xph,'P2 j+1,j+2 Errors:',EP2jm2tojjp1,EP2jm2tojjp2 )  
        
        
        P2jm1tojp1jm2LE = P2jm1tojp1a22/3*(-5*dx/2)**3 + P2jm1tojp1a21/2*(-5*dx/2)**2  +P2jm1tojp1a20*(-5*dx/2)
        P2jm1tojp1jm2RE = P2jm1tojp1a22/3*(-3*dx/2)**3 + P2jm1tojp1a21/2*(-3*dx/2)**2  +P2jm1tojp1a20*(-3*dx/2)
        EP2jm1tojp1jm2 = abs((P2jm1tojp1jm2RE - P2jm1tojp1jm2LE)/ dx - qajm2)

        P2jm1tojp1jp2LE = P2jm1tojp1a22/3*(3*dx/2)**3 + P2jm1tojp1a21/2*(3*dx/2)**2  +P2jm1tojp1a20*(3*dx/2)
        P2jm1tojp1jp2RE = P2jm1tojp1a22/3*(5*dx/2)**3 + P2jm1tojp1a21/2*(5*dx/2)**2  +P2jm1tojp1a20*(5*dx/2)
        EP2jm1tojp1jp2 = abs((P2jm1tojp1jp2RE - P2jm1tojp1jp2LE)/ dx - qajp2)     
        
        print(i,xmh,xph,'P2 j-2,j+2 Errors:',EP2jm1tojp1jm2,EP2jm1tojp1jp2 )  
        
        AvgP = Avga22*(xplot - x[i])**2 + Avga21*(xplot - x[i])   +Avga20   
        
        RP = Ra2*(xplot - x[i])**2 + Ra1*(xplot - x[i])   +Ra0  

        if i == nG:
            # plot(xplot, P0jplot, '-b',label='Recon P0')   
            
            plot(xplot, P2jtojp2P, '-g',label='Recon P2 j,j+2')
            plot(xplot, P2jm1tojp1P , '-r',label='Recon P2 j-1,j+1')
            plot(xplot, P2jm2tojP , '-b',label='Recon P2 j-2,j')
            
            # plot(xplot, AvgP , '-y',label=' Sym Avg')
            
            # plot(xplot, RP , '-m',label='Recon')
        else:
            plot(xplot, P2jtojp2P, '-g')
            plot(xplot, P2jm1tojp1P , '-r')
            plot(xplot, P2jm2tojP , '-b')
            # plot(xplot, AvgP , '-y')
