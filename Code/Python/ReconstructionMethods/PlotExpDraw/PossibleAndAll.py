...
def PlotBuildUpToQuad(x,q,dx,nG,np):
    ...
    for i in range(nG,n-nG):
        ...
        P4a2 = P4jm2tojp2a42
        P4a1 = P4jm2tojp2a41
        P4a0 = qaj -P4a2/3*(dx/2)**2 
        CAP4 = P4a2*(xplot - x[i])**2 + P4a1*(xplot - x[i])   +P4a0
        
        
        AA2 = (P2jtojp2a22 + 0*P2jm1tojp1a22 + P2jm2toja22)/2
        AA1 = (P2jtojp2a21 + 0*P2jm1tojp1a21 + P2jm2toja21)/2
        # AA0 = (P2jtojp2a20 + 0*P2jm1tojp1a20 + P2jm2toja20)/2
        AA0 = qaj- AA2/3*(dx/2)**2 
        
        APLR2 = AA2*(xplot - x[i])**2 + AA1*(xplot - x[i])  +AA0
        ...
        # print(i,xmh,xph,P3jm3toja33,P3jm3toja32,P3jm3toja31,P3jm3toja30)
        # print(i,xmh,xph,P3jm2tojp1a33,P3jm2tojp1a32,P3jm2tojp1a31,P3jm2tojp1a30)
        # print(i,xmh,xph,P3jm1tojp2a33,P3jm1tojp2a32,P3jm1tojp2a31,P3jm1tojp2a30)
        # print(i,xmh,xph,P3jtojp3a33,P3jtojp3a32,P3jtojp3a31,P3jtojp3a30)

        print(i,xmh,xph,'P1 j-1,j',P1jm1toja11,P1jm1toja10)
        print(i,xmh,xph,'P1 j,j+1',P1jtojp1a11,P1jtojp1a10)
        print(i,xmh,xph,'P1C j-1,j+1',P2jm1tojp1a21,P2jm1tojp1a20)
        
        print(i,xmh,xph,'P2 j-2,j',P2jm2toja22,P2jm2toja21,P2jm2toja20)
        print(i,xmh,xph,'P2 j,j+2',P2jtojp2a22,P2jtojp2a21,P2jtojp2a20)
        print(i,xmh,xph,'P4C j-2,j+2',P4a2,P4a1,P4a0)
        # print(i,xmh,xph,'P40 P2 j,j+2',P4a2,P4a1,P4a0)
        # print(i,xmh,xph,'AP2 ', AA2, AA1, AA0)
        ...
        if i == nG:
            ...
            # plot( xplot, P2jm2toja22*(xplot - x[i])**2 - P2jm2toja21*(xplot - x[i])   +P2jm2toja20, '--',color ='darkblue',label='P2 j-2,j Flip', linewidth=lw)
            # plot( xplot, P2jtojp2a22*(xplot - x[i])**2 - P2jtojp2a21*(xplot - x[i])   +P2jtojp2a20, '--',color ='seagreen',label='P2 j,j+2 Flip', linewidth=lw)
            

            # plot(xplot,  CAP4, '--',color ='seagreen',label='CP2 j-2,j+2', linewidth=lw)
            # plot(xplot,  APLR2, '--',color ='gold',label='APLR2 j-2,j and j,j+2', linewidth=lw)
            ...
            # plot( xplot, P2jm2toja22*(xplot - x[i])**2 - P2jm2toja21*(xplot - x[i])   +P2jm2toja20, '--',color ='darkblue', linewidth=lw)
            # plot( xplot, P2jtojp2a22*(xplot - x[i])**2 - P2jtojp2a21*(xplot - x[i])   +P2jtojp2a20, '--',color ='seagreen', linewidth=lw)
            
            # plot(xplot,  CAP4, '--',color ='seagreen', linewidth=lw)
            
            # plot(xplot,  APLR2, '--',color ='gold', linewidth=lw)


            # plot(xplot,P3jm3tojP ,'-',color = 'darkblue', linewidth=lw)
            # plot(xplot, P3jm2tojp1P, '-',color ='seagreen', linewidth=lw)
